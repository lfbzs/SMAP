...
def my_lodelmodel():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/UI/weights/best.pt',help='model.pt path(s)')
...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    return im0,label,imgs_information,save_dir


def parse_opt(source_open):
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/UI/weights/last.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=source_open, help='file/dir/URL/glob, 0 for webcam')
...
def main(opt):
    ...
    im0,label,imgs_information,save_dir = run(**vars(opt))
    return im0,label,imgs_information,save_dir
