...
# def creat_txt(txt01_path,mung_path):
...
if __name__ == '__main__':
    labels_path = r"/Users/loufengbin/Documents/python/pythonProject/tensorflow/YOLO/yolov5-Pyqt/runs/detect/exp29/labels"
    exp_path = r"/Users/loufengbin/Documents/python/pythonProject/tensorflow/YOLO/yolov5-Pyqt/runs/detect/exp29"

    mung_path = os.path.join(exp_path, "mung/")
    if not os.path.isdir(mung_path):
        os.mkdir(mung_path)
    imgs_infor = creat_txt(labels_path,mung_path)
